...
from FromNothing.FromNothing import *
...
class TestFromNothing(unittest.TestCase):
    ...
    def test_src_dir_exist(self):
        ...
        self.assertTrue(os.path.isfile('src/main.c'))

    def test_include_dir_exist(self):
        self.assertTrue(os.path.isdir('include'))
        self.assertTrue(os.path.isfile('include/dummy.h'))
 
    def test_test_dir_exist(self):
        self.assertTrue(os.path.isdir('test'))
        self.assertTrue(os.path.isfile('test/test_files/test_dummy.c'))

    def test_doc_dir_exist(self):
        self.assertTrue(os.path.isdir('doc'))
        self.assertTrue(os.path.isfile('doc/dummy.md'))
